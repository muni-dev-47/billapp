...
//                 <div className="card-header bg-gradient-indigo text-primery">
//                     <div className="d-flex justify-content-between align-items-center">
//                         <div>
//                             <h5 className="mb-0 fw-semibold tracking-wide text-primary">
//                                 <i className="bi bi-credit-card me-2 text-white-80"></i>
//                                 ORDER HISTORY
//                             </h5>
//                             <small className="text-dark-70">View and manage your purchase records</small>
//                         </div>
//                         <div className="d-flex gap-3 align-items-center">
//                             <div className="input-group input-group-sm bg-white rounded-pill" style={{ width: '220px' }}>
...
//                                 <tr>
//                                     <th className="ps-4 text-indigo-600 text-uppercase fw-semibold small">Order ID</th>
//                                     <th className="text-indigo-600 text-uppercase fw-semibold small">Date</th>
//                                     <th className="text-indigo-600 text-uppercase fw-semibold small">Amount</th>
//                                     <th className="pe-4 text-end text-indigo-600 text-uppercase fw-semibold small">Action</th>
//                                 </tr>
//                             </thead>
//                             <tbody>
...
//                                             <td className="text-muted">{new Date(purchase.date).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}</td>
//                                             <td className="fw-bold text-indigo-600">₹{purchase.total.toLocaleString()}</td>
//                                             <td className="pe-4 text-end">
//                                                 <button
//                                                     className="btn btn-sm bg-white text-indigo-600 rounded-pill px-3 border border-indigo-100 hover:bg-indigo-50 transition-all"
//                                                     onClick={() => navigate("/editBill", { state: { cusId: location?.state?.id, billId: purchase.id } })}
//                                                 >
